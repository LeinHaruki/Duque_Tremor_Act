                    ...
                    <form action="{{ route('doctors.update', $doctor) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="middle_initial" id="middle_initial" class="form-control @error('middle_initial') is-invalid @enderror" 
                                       value="{{ old('middle_initial', $doctor->middle_initial) }}" maxlength="1" style="text-transform:uppercase">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="contact" id="contact" class="form-control @error('contact') is-invalid @enderror" 
                                   value="{{ old('contact', $doctor->contact) }}" required>
                            @error('contact')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="specializations-container">
                                @php
                                    $existingSpecializations = old('specializations', $doctor->specializations->pluck('specialization')->toArray());
                                    if (empty($existingSpecializations)) {
                                        $existingSpecializations = [''];
                                    }
                                @endphp
                                
                                @foreach($existingSpecializations as $index => $specialization)
                                    <div class="specialization-input mb-2 d-flex">
                                        <div class="position-relative flex-grow-1">
                                            <input type="text" name="specializations[]" class="form-control specialization-input-field @error('specializations') is-invalid @enderror" 
                                                   placeholder="Enter specialization" value="{{ $specialization }}" required autocomplete="off">
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm ms-2 remove-specialization" 
                                                style="{{ count($existingSpecializations) === 1 ? 'display: none;' : '' }}">
